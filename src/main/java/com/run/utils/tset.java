...
public class tset {
    ...
    private static final char [] ChineseUnit={'里','分','角',' ','拾','佰','仟','万','拾','佰','仟','亿','拾','佰','仟'};
...
//        money = new BigDecimal(22222.0);
        String moneyStr="450019";
        try {
            for (int i = 0; i< 100000;i++) {
                System.out.println(i +":"+ arabNumToChineseRMB(Integer.toString(i)));
            }
